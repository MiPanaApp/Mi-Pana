              ...
              <div className="flex items-center gap-3 md:gap-4 w-full">
                ...
                <div className="relative flex-1">
                  <input
                    ...
                    className={`w-full h-11 md:h-14 pl-11 md:pl-16 ${filters.searchQuery ? 'pr-12' : 'pr-4 md:pr-6'} bg-[#FFCC00] rounded-xl md:rounded-2xl text-sm md:text-lg text-[#1A1A3A] font-bold placeholder:text-[#1A1A3A] shadow-[inset_4px_4px_8px_rgba(204,163,0,0.6),inset_-4px_-4px_8px_rgba(255,255,255,0.8)] focus:outline-none focus:ring-2 focus:ring-[#0056B3]/40 transition-all`}
                  />
